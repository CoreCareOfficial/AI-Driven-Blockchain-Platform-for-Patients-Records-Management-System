...
function EndSignupPage() {
    ...
    const successfulChangePassword = async () => {
        ...
        try {
            const userResponse = await fetch("https://corecare-server.onrender.com/login/forget", {
                method: "PUT",
                headers: {
    ...
    const successfulCreated = async () => {
        ...
        if (type === "Patient" || type === "Doctor") {
            ...
            try {
                const response = await fetch("https://corecare-server.onrender.com/patients", {
                    method: "POST",
                    body: formData
                });
                if (response.ok) {
                    ...
                    if (type === "Doctor") {
                        ...
                        try {
                            const doctorResponse = await fetch("https://corecare-server.onrender.com/doctors", {
                                method: "POST",
                                body: doctorFormData
                            });
            ...
            try {
                const response = await fetch("https://corecare-server.onrender.com/healthcareproviders", {
                    method: "POST",
                    body: formData
                });
                if (response.ok) {
