...
export function UpdateImage(props) {
    ...
    const featchImageFacility = async (imageFile) => {
        ...
        try {
            const response = await fetch(`https://corecare-server.onrender.com/healthcareproviders/updatefacilityphoto/${props.username}`, {
                method: "PUT",
                body: formData
            });
    ...
    const featchImagePersonal = async (imageFile) => {
        ...
        try {
            const response = await fetch(`https://corecare-server.onrender.com/patients/personalphoto/${props.username}`, {
                method: "PUT",
                body: formData
            });
            console.log("res = " + response);
...
export function AddEmergency(props) {
    ...
    const changState = async (e) => {
        ...
        try {
            const response = await fetch(`https://corecare-server.onrender.com/emergencycontacts`, {
                method: "POST",
                headers: {
