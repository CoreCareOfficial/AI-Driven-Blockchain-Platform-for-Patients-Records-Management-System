...
function ProfileHeader(props) {
    return (
        <div className="profile-header">
            ...
            <ImageNameContainer userType={props.userType} location={props.location} image={props.image} username={props.username} name={props.name} gender={props.gender} age={props.age} />
