                    ...
                    <div style={{ marginTop: '10px', borderRadius: '8px', backgroundColor: '#272c34', justifyContent: 'space-around', display: 'flex', flexWrap: 'wrap' }}>
                        <>
                            ...
                            <div style={{ paddingRight: '5px', marginTop: '10px', width: '30%' }}>
                                ...
                                <AddAccountSelect items={['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-']} required={true} label="Blood Type:" name="AddAccountBlood" value={userInfo.bloodtype} />
                            ...
                            <div style={{ paddingRight: '5px', marginTop: '10px', width: '30%' }}>
                                ...
                                <AddAccountInput label="License Number:" name="" value="" type="number" required={true} placeholder="" />
                                <AddAccountInput label="Location of Work:" name="" value="" type="number" required={true} placeholder="" />
                                <AddAccountPassport title="Upload License document " />
                            </div>
                        </>
                    </div>
                </AddAccountForm>
