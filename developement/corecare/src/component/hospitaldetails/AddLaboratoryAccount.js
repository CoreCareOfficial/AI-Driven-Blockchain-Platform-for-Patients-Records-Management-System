...
function AddLaboratoryAccount(props) {
    ...
    const handleOnSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast.current.show({ severity: 'error', summary: 'Error', detail: `Failed Adding Laboratory` });
            }
        } catch (error) {
            console.error(error.message);
    ...
    return (
        <>
            <Toast ref={toast} />
            <Container>
                <AddAccountForm label="Add Laboratory" onSubmit={handleOnSubmit}>
